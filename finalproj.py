...
def create_app_ui():
    ...
    html.H1('CDR Analysis with Insights', id='Main_title',style={'backgroundColor':'white',"color":'#5c669c','align':'center','textAlign':'center'}),
    
    dcc.Tabs(id="Tabs", value="tab-1",children=[
    dcc.Tab(label="Call Analytics tool" ,id="Call Analytics tool",value="tab-1",style={'backgroundColor':'#afcce3'}, children = [
    ...
    dcc.Dropdown(
          ...
          style={
              'backgroundColor':'#dceefc',"color":"black"}
    ...
    dcc.Tab(label = "Service Analytics tool", id="Service Analytics tool", value="tab-3",style={'backgroundColor':'#afcce3'}, children = [            
    html.Br(),
    dcc.Dropdown(
...
def update_app_ui(Tabs, start_date, end_date, group, report_type,device_date,service_date):
    ...
    if Tabs == "tab-1":
        ...
        page_size=5,
        page_action='native',
        style_header={'backgroundColor': 'rgb(211, 217, 227)'},
        style_cell={
            'backgroundColor': 'rgb(161, 168, 181)',
            'color': '#0d0f12'
        }
        )
